...
and cheapest. The output of the piezo-electric transducer suffered from lack of dynamic response - hitting it hard or softly did not change the 
...
A follow-up project was a xylophone-style trigger interface device built from a child's toy. 
